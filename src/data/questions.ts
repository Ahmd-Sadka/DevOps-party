...
const wrongFeedbackPool = [
  ...
  "Nice try! But production would be crying right now 😭",
  "A real DevOps engineer fails fast and learns faster 🚀",
  "Close! But that's how you get a Slack message at dinner 🍝",
  "Hmm, that's how incidents start... 🚨",
  "Your future self would debug this for hours 🕐",
  "The logs would be very confused right now 📜",
  "That's a spicy way to break things! 🌶️",
  "Production would like to have a word with you 💬",
  "Stack Overflow would judge you for this one 👀",
  "Somewhere, a senior engineer just felt a disturbance 🧘",
  "That answer just triggered a PagerDuty incident 📟",
  "The CI/CD pipeline is crying in the corner 😢",
  "kubectl get fired --reason=this-answer 💀",
  "git blame would point directly at you right now 🫵",
  "That's a resume-generating event right there 📄",
  "Even ChatGPT would have gotten this one right 🤖",
  "Your Kubernetes cluster just rage-quit 🏃",
  "Terraform would plan to destroy your career for that 🏗️",
  "The monitoring dashboard just turned entirely red 🔴",
  "docker rm --force your-confidence 🐳",
  "Alert: Brain process returned exit code 1 🧠",
  "That answer has 'works on my machine' energy 💻",
  "The postmortem for this answer would be legendary 📋",
  "Your SSH key to success just got revoked 🔑",
];
...
export const questions: Question[] = [
  ...
  },
  {
    ...
    options: [
      'Sends SIGTERM to process 1234 gracefully',
      'Sends SIGKILL to process 1234 forcefully',
      'Kills 9 processes starting from PID 1234',
      'Restarts process 1234 after 9 seconds delay',
    ],
    correctAnswer: 1,
  ...
  },
  {
    ...
    options: [
      'ls -la / (list all root files)',
      'du -sh /* | sort -hr | head -10',
      'df -h (show filesystem usage)',
      'free -m (show memory details)',
    ],
    correctAnswer: 1,
  ...
  },
  {
    ...
    options: [
      'ps aux | grep 8080 (process list)',
      'netstat -tulpn | grep 8080 (ports)',
      'find /proc -port 8080 (proc files)',
      'top -p 8080 (monitor processes)',
    ],
    correctAnswer: 1,
  ...
  },
  {
    ...
    options: [
      'Stores encrypted user password hashes',
      'Contains user account info and UIDs',
      'Lists all running system processes',
      'Configures network password policies',
    ],
    correctAnswer: 1,
  ...
  },
  {
    ...
    options: [
      ...
      'top or htop to check resources',
      'tail -f /var/log/syslog output',
  ...
  },
  {
    ...
    options: [
      ...
      'Follows and shows new lines in real-time',
      'Filters the log file for errors only',
      'Shows detailed file metadata and info',
    ],
    correctAnswer: 1,
  ...
  },
  {
    ...
    options: [
      'Compares the two files side by side',
      'Concatenates files and saves to combined',
      'Creates two separate copies of combined',
      'Deletes file1 and file2 after merging',
    ],
    correctAnswer: 1,
  ...
  },
  {
    ...
    options: [
      'Nothing, modern systems prevent it fully',
      'Only empty directories get removed first',
      'The entire filesystem gets deleted forever',
      'It asks for confirmation before executing',
    ],
    correctAnswer: 2,
  ...
  },
  {
    ...
    options: [
      'A compressed file format for archiving data',
      'A symbolic link pointing to another file path',
      'A system synchronization tool between hosts',
      'A network connection type for remote access',
    ],
    correctAnswer: 1,
  ...
  },
  {
    ...
    options: [
      'No difference, they do the same exact thing',
      'Merge creates a commit, rebase rewrites linearly',
      'Merge is for local branches, rebase for remote',
      'Merge is faster to execute, rebase is safer',
    ],
    correctAnswer: 1,
  ...
  },
  {
    ...
    options: [
      'git delete commit (purge from history)',
      'git rm --cached && git commit --amend',
      'git filter-branch or BFG Repo-Cleaner',
      'Just delete the file and commit the change',
    ],
    correctAnswer: 2,
  ...
  },
  {
    ...
    options: [
      'Selects the best commits from history automatically',
      'Applies specific commits from branch to another',
      'Removes unwanted commits from branch history',
      'Optimizes the repository for faster cloning',
    ],
    correctAnswer: 1,
  ...
  },
  {
    ...
    options: [
      'They are the exact same command with an alias',
      'Fetch downloads only, pull downloads and merges',
      'Fetch is for branches only, pull is for files',
      'Pull is always faster than fetch in execution',
    ],
    correctAnswer: 1,
  ...
  },
  {
    ...
    options: [
      'Viewing history of where HEAD has been',
      'Logging errors to a persistent file store',
      'Refreshing the log view in the terminal',
      'Creating reference documentation for repo',
    ],
    correctAnswer: 0,
  ...
  // ============ LEVEL 4: DOCKER ARCHITECT ============
  {
    ...
    options: [
      ...
      'Image is a template, container is a running one',
      'Container is the template, image runs from it',
      'Image is for dev only, container for production',
    ],
    correctAnswer: 1,
  ...
  },
  {
    ...
    options: [
      'Documents the Docker installation steps',
      'Defines instructions to build an image',
      'Stores container runtime log outputs',
      'Configures the Docker daemon settings',
    ],
    correctAnswer: 1,
  ...
  },
  {
    ...
    options: [
      'No difference, they are just aliases for each other',
      'ENTRYPOINT is the main command, CMD gives defaults',
      'CMD runs before ENTRYPOINT during container start',
      'ENTRYPOINT is for dev mode, CMD for production',
    ],
    correctAnswer: 1,
  ...
  },
  {
    ...
    options: [
      'Data is always persisted automatically by Docker',
      'Use Docker volumes or bind mounts for storage',
      'Use the --persist flag when running containers',
      'Save important data to environment variables only',
    ],
    correctAnswer: 1,
  ...
  },
  {
    ...
    options: [
      'Use a larger build server with more RAM and CPU',
      'Multi-stage builds, slim base, .dockerignore, cache',
      'Compress the final image after the build completes',
      'Split into multiple containers to reduce each size',
    ],
    correctAnswer: 1,
  ...
  },
  {
    ...
    options: [
      ...
      'Starts all services in compose file detached',
      'Downloads all referenced images from registry',
      'Destroys all running containers and volumes',
    ],
    correctAnswer: 1,
  ...
  },
  {
    ...
    options: [
      'Connect containers to the public internet only',
      'Enable container communication and isolation',
      'Speed up image downloads from Docker Hub only',
      'Store and persist network logs to a volume',
    ],
    correctAnswer: 1,
  ...
  },
  {
    ...
    options: [
      'Out Of Memory - exceeded limit, increase or fix',
      'Out Of Mounts - not enough volumes attached',
      'Object Oriented Module error - fix app code',
      'Old Operating Module - needs Docker update',
    ],
    correctAnswer: 0,
  ...
  },
  {
    ...
    options: [
      'Building multiple images at once in parallel',
      'Using multiple FROM to create smaller images',
      'Building the same image in multiple data centers',
      'Running parallel image builds for speed only',
    ],
    correctAnswer: 1,
  ...
  },
  {
    ...
    options: [
      'No difference, they are interchangeable commands',
      'ADD extracts archives and URLs, COPY is simpler',
      'COPY is for large files only, ADD for small ones',
      'ADD is deprecated in newer Docker versions now',
    ],
    correctAnswer: 1,
  ...
  },
  {
    ...
    options: [
      'Docker doesn\'t support PostgreSQL databases',
      'localhost refers to the container, not host',
      'Port 5432 is reserved by the Docker daemon',
      'Docker blocks all database connections by default',
    ],
    correctAnswer: 1,
  ...
  },
  {
    ...
    options: [
      'Executes a bash script on the host machine',
      'Opens an interactive bash shell inside container',
      'Creates a new container with bash entry point',
      'Exports container filesystem to a bash file',
    ],
    correctAnswer: 1,
  ...
  },
  {
    ...
    options: [
      'Layers are backup copies of previous images',
      'Each instruction creates a cached layer; order matters',
      'Layers are security levels for access control',
      'Order doesn\'t matter, Docker optimizes it all',
    ],
    correctAnswer: 1,
  ...
  },
  {
    ...
    options: [
      'Opens the port automatically on the host',
      'Documents which ports the container listens on',
      'Exposes the source code to other containers',
      'Makes the container publicly accessible online',
    ],
    correctAnswer: 1,
  ...
  // ============ LEVEL 5: DEVOPS MASTER ============
  {
    ...
    options: [
      'Run all tests sequentially for max accuracy',
      'Caching, parallelism, incremental builds, slim images',
      'Skip tests entirely in CI pipeline runs only',
      'Use a more powerful server, nothing else needed',
    ],
    correctAnswer: 1,
  ...
  },
  {
    ...
    options: [
      'Check the code for bugs in the latest commit',
      'Restart all servers and hope it comes back up',
      'Check monitoring and logs for the failing part',
      'Roll back to previous version without checking',
    ],
    correctAnswer: 2,
  ...
  },
  {
    ...
    options: [
      'They are the same deployment strategy with aliases',
      'Blue-green switches all at once, canary is gradual',
      'Blue-green is for databases, canary for web apps',
      'Canary is always faster than blue-green deploys',
    ],
    correctAnswer: 1,
  ...
  },
  {
    ...
    options: [
      'Container keeps crashing; check kubectl logs',
      'Network loop detected; restart the cluster',
      'Storage is full; clear old container images',
      'Node is overloaded; add more worker nodes',
    ],
    correctAnswer: 0,
  ...
  },
  {
    ...
    options: [
      'Writing infrastructure docs in code comments only',
      'Managing infra through versioned, automated code',
      'Coding inside virtual machines for portability',
      'Converting infrastructure to a programming language',
    ],
    correctAnswer: 1,
  ...
  },
  {
    ...
    options: [
      'Balances database load across table shards',
      'Distributes traffic across multiple servers',
      'Reduces overall application code complexity',
      'Balances CPU usage within a single server',
    ],
    correctAnswer: 1,
  ...
  },
  {
    ...
    options: [
      'Use the fastest single server available in region',
      'Redundancy, auto-scaling, multi-region, failover',
      'Manual monitoring and quick incident response only',
      'Over-provision resources significantly on one host',
    ],
    correctAnswer: 1,
  ...
  },
  {
    ...
    options: [
      'Store them in the git repository encrypted with GPG',
      'Use secret managers (Vault, AWS SM), inject at runtime',
      'Hardcode them in environment variables in CI config',
      'Store in a shared secure document for team leads only',
    ],
    correctAnswer: 1,
  ...
  },
  {
    ...
    options: [
      'Connects services to WiFi network interfaces',
      'Handles service comms, observability, security',
      'Meshes database tables together for queries',
      'Creates visual diagrams of service topology',
    ],
    correctAnswer: 1,
  ...
  },
  {
    ...
    options: [
      'Using Git for operations documentation only',
      'Using Git as single source of truth for infra',
      'Git optimization techniques for large repos',
      'Operating system designed for Git servers',
    ],
    correctAnswer: 1,
  ...
  },
  {
    ...
    options: [
      'Roll back all 50 deployments and start fresh',
      'Check timestamps, correlate alerts, use flags',
      'Ask each developer who changed what and when',
      'Wait for users to report the specific issues',
    ],
    correctAnswer: 1,
  ...
  },
  {
    ...
    options: [
      'Rewrite everything from scratch as microservices',
      'Strangler fig: gradually extract while running',
      'Stop all development until migration is complete',
      'Containerize the monolith, that makes it micro',
    ],
    correctAnswer: 1,
  ...
  },
  {
    ...
    options: [
      ...
      'SLI is the metric, SLO the target, SLA the deal',
      'Different names used by different cloud providers',
      'SLI for internal, SLO for customers, SLA legal',
    ],
    correctAnswer: 1,
...
// Get questions by their IDs (for review mode)
export const getQuestionsByIds = (ids: string[]): Question[] => {
  const allWithInterview = [...allQuestions, ...juniorInterviewQuestions];
  return ids.map(id => allWithInterview.find(q => q.id === id)).filter(Boolean) as Question[];
};
